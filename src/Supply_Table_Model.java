...
public class Supply_Table_Model extends AbstractTableModel{
    ...
    public void buildDBConnection(){
       ...
       try {
            ...
            CallableStatement cs = dbConnection.prepareCall("begin ? := retail_business.show_Supply(); end;");
	    ...
	    //register the out parameter (the first parameter)
            ...
            sup_columns=new String[column_count];
            
            data=new Vector();
            
            for(int i=1;i<=column_count;i++) {
                sup_columns[i-1]=meta.getColumnName(i);
            }
